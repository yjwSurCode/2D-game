...
// const log = createLogger('native-bridge');
...
// 		const id = `__native_bridge__${bridgeIdx++}`;
...
// 			/* 触屏 */
// 		} else {
// 			log.info(`invoke bridge: '${method}'`, param);
// 			win[id]();
// 		}
// 	}
...
// 				log.info(`invoke 'bridge: ${method}', 'params: ${param}', 'result: ${args}'`);
...
// 	 * @returns
// 	 */
// 	async wechatShareImage(imageData: string): Promise<void> {
// 		imageData = imageData.replace(/^data:(.*);base64,\s*/, '');
// 		this.invokeBridge('wechatShareImage', { shareImageData: imageData });
// 	}
